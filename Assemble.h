#pragma once
namespace Assemble {
	vector<SA::Function> functionList;
...
#undef c
			...
			case CALL: {
				lli functionIndex = indexVec_lambda<string, SA::Function>(i.oprand_string[0], functionList,
					[](string& s, SA::Function& func)->bool {
						return s == func.name;
					});
#if safe == true
	...
	string AssembleCode(vector<SA::Function>& functionList_arg) {
